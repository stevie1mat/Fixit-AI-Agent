          ...
          <section className="w-full pb-16">
            <div className="relative">
              ...
              <div className="flex overflow-x-auto scrollbar-hide gap-6 px-6 snap-x snap-mandatory">
                {/* Smart Analysis */}
                <div className="flex-shrink-0 w-80 bg-gray-50 border border-gray-300 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 snap-start transform hover:scale-105 blur-sm hover:blur-none">
                ...
                <div className="flex-shrink-0 w-80 bg-gray-100 border-2 border-gray-600 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 snap-start transform hover:scale-105">
                  <div className="text-center mb-6">
