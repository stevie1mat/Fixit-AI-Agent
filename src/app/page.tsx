        ...
        <main className="flex flex-col items-center justify-center px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-urbanist font-light text-gray-900">Smart Analysis</h3>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-urbanist font-light text-gray-900">Auto Optimization</h3>
            </div>
            ...
            <div className="bg-white border-2 border-black rounded-xl p-6 hover:shadow-lg transition-shadow transform scale-105">
              ...
              <h3 className="font-urbanist font-light text-gray-900">AI Chat Assistant</h3>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-urbanist font-light text-gray-900">Store Integration</h3>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-urbanist font-light text-gray-900">Performance Tracking</h3>
            </div>
          </div>
        </section>
        </main>
